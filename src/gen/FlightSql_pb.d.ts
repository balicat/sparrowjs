 ...
 */
export declare const file_FlightSql: GenFile;
 ...
 */
export declare type CommandGetXdbcTypeInfo = Message<"arrow.flight.protocol.sql.CommandGetXdbcTypeInfo"> & {
  /**
   *
 ...
 */
export declare type CommandGetCatalogs = Message<"arrow.flight.protocol.sql.CommandGetCatalogs"> & {
};
 ...
 */
export declare type CommandGetDbSchemas = Message<"arrow.flight.protocol.sql.CommandGetDbSchemas"> & {
  /**
   *
 ...
 */
export declare type CommandGetTableTypes = Message<"arrow.flight.protocol.sql.CommandGetTableTypes"> & {
};
 ...
 */
export declare type CommandGetPrimaryKeys = Message<"arrow.flight.protocol.sql.CommandGetPrimaryKeys"> & {
  /**
   *
 ...
 */
export declare type CommandGetExportedKeys = Message<"arrow.flight.protocol.sql.CommandGetExportedKeys"> & {
  /**
   *
 ...
 */
export declare type CommandGetImportedKeys = Message<"arrow.flight.protocol.sql.CommandGetImportedKeys"> & {
  /**
   *
 ...
 */
export declare type CommandGetCrossReference = Message<"arrow.flight.protocol.sql.CommandGetCrossReference"> & {
  /**
   * *
 ...
 */
export declare type ActionCreatePreparedStatementRequest = Message<"arrow.flight.protocol.sql.ActionCreatePreparedStatementRequest"> & {
  /**
 ...
 */
export declare type ActionCreatePreparedSubstraitPlanRequest = Message<"arrow.flight.protocol.sql.ActionCreatePreparedSubstraitPlanRequest"> & {
  /**
   * The serialized substrait.Plan to create a prepared statement for.
   *
 ...
 */
export declare type ActionCreatePreparedStatementResult = Message<"arrow.flight.protocol.sql.ActionCreatePreparedStatementResult"> & {
  /**
   ...
   *
   * @generated from field: optional bool is_update = 4;
   */
 ...
 */
export declare type ActionClosePreparedStatementRequest = Message<"arrow.flight.protocol.sql.ActionClosePreparedStatementRequest"> & {
  /**
   * Opaque handle for the prepared statement on the server.
   *
   * @generated from field: bytes prepared_statement_handle = 1;
 ...
 */
export declare type ActionBeginTransactionRequest = Message<"arrow.flight.protocol.sql.ActionBeginTransactionRequest"> & {
};
 ...
 */
export declare type ActionBeginSavepointRequest = Message<"arrow.flight.protocol.sql.ActionBeginSavepointRequest"> & {
  /**
 ...
 */
export declare type ActionBeginTransactionResult = Message<"arrow.flight.protocol.sql.ActionBeginTransactionResult"> & {
  /**
 ...
 */
export declare type ActionBeginSavepointResult = Message<"arrow.flight.protocol.sql.ActionBeginSavepointResult"> & {
  /**
 ...
 */
export declare type ActionEndTransactionRequest = Message<"arrow.flight.protocol.sql.ActionEndTransactionRequest"> & {
  /**
   * Opaque handle for the transaction on the server.
   *
   * @generated from field: bytes transaction_id = 1;
 ...
 */
export declare type ActionEndSavepointRequest = Message<"arrow.flight.protocol.sql.ActionEndSavepointRequest"> & {
  /**
   * Opaque handle for the savepoint on the server.
   *
   * @generated from field: bytes savepoint_id = 1;
 ...
 */
export declare type CommandStatementQuery = Message<"arrow.flight.protocol.sql.CommandStatementQuery"> & {
  /**
   * The SQL syntax.
   *
   * @generated from field: string query = 1;
 ...
 */
export declare type CommandStatementSubstraitPlan = Message<"arrow.flight.protocol.sql.CommandStatementSubstraitPlan"> & {
  /**
 ...
 */
export declare type TicketStatementQuery = Message<"arrow.flight.protocol.sql.TicketStatementQuery"> & {
  /**
 ...
 */
export declare type CommandPreparedStatementQuery = Message<"arrow.flight.protocol.sql.CommandPreparedStatementQuery"> & {
  /**
   * Opaque handle for the prepared statement on the server.
   *
   * @generated from field: bytes prepared_statement_handle = 1;
 ...
 */
export declare type CommandStatementUpdate = Message<"arrow.flight.protocol.sql.CommandStatementUpdate"> & {
  /**
   * The SQL syntax.
   *
   * @generated from field: string query = 1;
 ...
 */
export declare type CommandPreparedStatementUpdate = Message<"arrow.flight.protocol.sql.CommandPreparedStatementUpdate"> & {
  /**
   * Opaque handle for the prepared statement on the server.
   *
   * @generated from field: bytes prepared_statement_handle = 1;
 ...
 */
export declare type CommandStatementIngest = Message<"arrow.flight.protocol.sql.CommandStatementIngest"> & {
  /**
 ...
 */
export declare type CommandStatementIngest_TableDefinitionOptions = Message<"arrow.flight.protocol.sql.CommandStatementIngest.TableDefinitionOptions"> & {
  /**
 ...
 */
export declare type DoPutPreparedStatementResult = Message<"arrow.flight.protocol.sql.DoPutPreparedStatementResult"> & {
  /**
 ...
 * @deprecated
 */
export declare type ActionCancelQueryRequest = Message<"arrow.flight.protocol.sql.ActionCancelQueryRequest"> & {
  /**
 ...
 * @deprecated
 */
export declare type ActionCancelQueryResult = Message<"arrow.flight.protocol.sql.ActionCancelQueryResult"> & {
  /**
