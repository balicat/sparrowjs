 ...
 */
export declare const file_Flight: GenFile;
 ...
 */
export declare type HandshakeRequest = Message<"arrow.flight.protocol.HandshakeRequest"> & {
  /**
   *
 ...
 */
export declare type HandshakeResponse = Message<"arrow.flight.protocol.HandshakeResponse"> & {
  /**
   *
   * A defined protocol version
   *
 ...
 */
export declare type BasicAuth = Message<"arrow.flight.protocol.BasicAuth"> & {
  /**
 ...
 */
export declare type Empty = Message<"arrow.flight.protocol.Empty"> & {
};
 ...
 */
export declare type ActionType = Message<"arrow.flight.protocol.ActionType"> & {
  /**
 ...
 */
export declare type Criteria = Message<"arrow.flight.protocol.Criteria"> & {
  /**
 ...
 */
export declare type Action = Message<"arrow.flight.protocol.Action"> & {
  /**
   * @generated from field: string type = 1;
   */
  type: string;
 ...
 */
export declare type Result = Message<"arrow.flight.protocol.Result"> & {
  /**
 ...
 */
export declare type SchemaResult = Message<"arrow.flight.protocol.SchemaResult"> & {
  /**
 ...
 */
export declare const SchemaResultSchema: GenMessage<SchemaResult>;
 ...
 */
export declare type FlightDescriptor = Message<"arrow.flight.protocol.FlightDescriptor"> & {
  /**
 ...
 */
export declare const FlightDescriptorSchema: GenMessage<FlightDescriptor>;
 ...
 */
export declare const FlightDescriptor_DescriptorTypeSchema: GenEnum<FlightDescriptor_DescriptorType>;
 ...
 */
export declare type FlightInfo = Message<"arrow.flight.protocol.FlightInfo"> & {
  /**
   * The schema of the dataset in its IPC form:
   *   4 bytes - an optional IPC_CONTINUATION_TOKEN prefix
   *   4 bytes - the byte length of the payload
 ...
 */
export declare const FlightInfoSchema: GenMessage<FlightInfo>;
 ...
 */
export declare type PollInfo = Message<"arrow.flight.protocol.PollInfo"> & {
  /**
   *
 ...
 */
export declare const PollInfoSchema: GenMessage<PollInfo>;
 ...
 */
export declare type CancelFlightInfoRequest = Message<"arrow.flight.protocol.CancelFlightInfoRequest"> & {
  /**
   * @generated from field: arrow.flight.protocol.FlightInfo info = 1;
   */
  info?: FlightInfo | undefined;
 ...
 */
export declare const CancelFlightInfoRequestSchema: GenMessage<CancelFlightInfoRequest>;
 ...
 */
export declare type CancelFlightInfoResult = Message<"arrow.flight.protocol.CancelFlightInfoResult"> & {
  /**
 ...
 */
export declare const CancelFlightInfoResultSchema: GenMessage<CancelFlightInfoResult>;
 ...
 */
export declare type Ticket = Message<"arrow.flight.protocol.Ticket"> & {
  /**
 ...
 */
export declare type Location = Message<"arrow.flight.protocol.Location"> & {
  /**
 ...
 */
export declare type FlightEndpoint = Message<"arrow.flight.protocol.FlightEndpoint"> & {
  /**
   *
 ...
 */
export declare const FlightEndpointSchema: GenMessage<FlightEndpoint>;
 ...
 */
export declare type RenewFlightEndpointRequest = Message<"arrow.flight.protocol.RenewFlightEndpointRequest"> & {
  /**
 ...
 */
export declare const RenewFlightEndpointRequestSchema: GenMessage<RenewFlightEndpointRequest>;
 ...
 */
export declare type FlightData = Message<"arrow.flight.protocol.FlightData"> & {
  /**
   *
 ...
 */
export declare const FlightDataSchema: GenMessage<FlightData>;
 ...
 */
export declare type PutResult = Message<"arrow.flight.protocol.PutResult"> & {
  /**
 ...
 */
export declare const PutResultSchema: GenMessage<PutResult>;
 ...
 */
export declare type SessionOptionValue = Message<"arrow.flight.protocol.SessionOptionValue"> & {
  /**
 ...
 */
export declare const SessionOptionValueSchema: GenMessage<SessionOptionValue>;

/**
 * @generated from message arrow.flight.protocol.SessionOptionValue.StringListValue
 */
export declare type SessionOptionValue_StringListValue = Message<"arrow.flight.protocol.SessionOptionValue.StringListValue"> & {
  /**
 ...
 */
export declare const SessionOptionValue_StringListValueSchema: GenMessage<SessionOptionValue_StringListValue>;
 ...
 */
export declare type SetSessionOptionsRequest = Message<"arrow.flight.protocol.SetSessionOptionsRequest"> & {
  /**
 ...
 */
export declare const SetSessionOptionsRequestSchema: GenMessage<SetSessionOptionsRequest>;
 ...
 */
export declare type SetSessionOptionsResult = Message<"arrow.flight.protocol.SetSessionOptionsResult"> & {
  /**
 ...
 */
export declare const SetSessionOptionsResultSchema: GenMessage<SetSessionOptionsResult>;

/**
 * @generated from message arrow.flight.protocol.SetSessionOptionsResult.Error
 */
export declare type SetSessionOptionsResult_Error = Message<"arrow.flight.protocol.SetSessionOptionsResult.Error"> & {
  /**
 ...
 */
export declare const SetSessionOptionsResult_ErrorSchema: GenMessage<SetSessionOptionsResult_Error>;
 ...
 */
export declare const SetSessionOptionsResult_ErrorValueSchema: GenEnum<SetSessionOptionsResult_ErrorValue>;
 ...
 */
export declare type GetSessionOptionsRequest = Message<"arrow.flight.protocol.GetSessionOptionsRequest"> & {
};
 ...
 */
export declare const GetSessionOptionsRequestSchema: GenMessage<GetSessionOptionsRequest>;
 ...
 */
export declare type GetSessionOptionsResult = Message<"arrow.flight.protocol.GetSessionOptionsResult"> & {
  /**
   * @generated from field: map<string, arrow.flight.protocol.SessionOptionValue> session_options = 1;
   */
  sessionOptions: { [key: string]: SessionOptionValue };
 ...
 */
export declare const GetSessionOptionsResultSchema: GenMessage<GetSessionOptionsResult>;
 ...
 */
export declare type CloseSessionRequest = Message<"arrow.flight.protocol.CloseSessionRequest"> & {
};
 ...
 */
export declare type CloseSessionResult = Message<"arrow.flight.protocol.CloseSessionResult"> & {
  /**
 ...
 */
export declare const CloseSessionResultSchema: GenMessage<CloseSessionResult>;
 ...
 */
export declare const CloseSessionResult_StatusSchema: GenEnum<CloseSessionResult_Status>;
 ...
 */
export declare const CancelStatusSchema: GenEnum<CancelStatus>;
 ...
 */
export declare const FlightService: GenService<{
  /**
   *
